...
* [MonologServiceLevelBundle](https://github.com/mops1k/monolog-service-level-bundle) - Bundle allow handlers with type 'service' in monolog to handle log level from monolog configuration
